...
;       
; PURPOSE:
;       AL_LEGEND, from idlastro, with an extra keyword (background_color),
;       to specifiy what color will fill the legend box when the keywrod
;       clear is set.
...
;       AL_LEGEND.     (The original legend.pro remains.)    
;
...
;       al_legend,items,/fill,psym=[8,8,8],colors=[10,20,30]; 3 filled squares
;       
; INPUTS:
...
;       background_color = color to fill the legend box when clear is set (D=-1)
...
;       Added background_color keyword. Paulo Penteado (pp.penteado@gmail.com), Sep/2010
;-
pro al_legend_pp, items, BOTTOM_LEGEND=bottom, BOX = box, CENTER_LEGEND=center, $
